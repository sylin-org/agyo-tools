...
| Agyo.Secrets | local build + pack | 2026-06-14 | green-ratchet build leg | Migrated from Koan src/Koan.Secrets.* (3 projects, config + HttpClient rebranded to Agyo); Sylin.Agyo.Secrets.* pack. The Koan.Data.Core reflection seam stays in Koan. Integration spec pending. |
| Agyo.Scheduling | local build + pack | 2026-06-14 | green-ratchet build leg | Migrated from Koan src/Koan.Scheduling (config rebranded Agyo:Scheduling); Sylin.Agyo.Scheduling packs. Koan.Web de-bloat is Koan-side (deferred); finish-vs-document cron decision open. Integration spec pending. |
| Agyo.Observability | local build + pack | 2026-06-14 | green-ratchet build leg | Migrated from Koan Recipe.Observability, re-expressed as an ARCH-0086 KoanModule (not IKoanRecipe); Sylin.Agyo.Observability packs. OTel honestly a TODO stub. Integration spec pending. |
