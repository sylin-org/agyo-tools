...
using Agyo.Secrets.Connector.Vault.Internal;
using Agyo.Secrets.Connector.Vault;
using Agyo.Secrets.Connector.Vault.Health;
using Agyo.Secrets.Connector.Vault.Orchestration;
using Koan.Core.Hosting.Bootstrap;

namespace Agyo.Secrets.Connector.Vault.Initialization;

public sealed class KoanAutoRegistrar : IKoanAutoRegistrar
{
    public string ModuleName => "Agyo.Secrets.Connector.Vault";
