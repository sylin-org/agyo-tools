...
using Agyo.Rag.Infrastructure;
using Agyo.Rag.Ingestion;
using Agyo.Rag.Retrieval;
...
namespace Agyo.Rag.Initialization;

/// <summary>
/// Auto-registers RAG infrastructure when <c>Agyo.Rag</c> is referenced.
...
/// <para>
/// <b>Reference = Intent:</b> Adding a package reference to <c>Agyo.Rag</c> and calling
...
{
    public string ModuleName => "Agyo.Rag";
