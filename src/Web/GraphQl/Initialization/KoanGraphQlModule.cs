...
namespace Agyo.Web.GraphQl.Initialization;

/// <summary>
/// Agyo.Web.GraphQl boot module (ARCH-0086). Replaces the former <c>KoanAutoRegistrar</c> +
...
{
    public override string Id => "Agyo.Web.GraphQl";
