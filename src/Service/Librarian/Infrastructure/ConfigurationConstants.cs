namespace Agyo.Service.Librarian.Infrastructure;

/// <summary>
/// Centralized configuration key constants for the Agyo.Service.Librarian service.
/// App-owned options live under "Agyo:Librarian"; framework sections (Koan:Data, Koan:AI,
/// Koan:Orchestration:Weaviate) are bound by the Koan packages and intentionally keep their "Koan:" root.
/// </summary>
internal static class ConfigurationConstants
{
    public const string ContextSection = "Agyo:Librarian";
